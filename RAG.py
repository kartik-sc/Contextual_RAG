...
class DocumentIntelligenceService:
    ...
    def __init__(self):
        ...
        self.api_version = "2024-11-30"  # changes mad to this version
...
if __name__ == "__main__":
    ...
    analysis_results = client.analyze(
        source="https://www.nsca.com/contentassets/de9aebfe7a7340b69217b99bb13862a7/basics_of_strength_and_conditioning_manual.pdf")
